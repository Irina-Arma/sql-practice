...
--Оператор NOT
--Получаем все книги, кроме книг Булгакова
SELECT title, author, price
FROM book
WHERE NOT author = 'Булгаков М.А.';


--Оператор NOT IN
--Получаем книги, авторы которых не Булгаков и не Достоевский
SELECT title, author, price
FROM book
WHERE author NOT IN ('Булгаков М.А.', 'Достоевский Ф.М.');


--Оператор BETWEEN и IN
...
--Оператор NOT LIKE
--Получаем книги, в названии которых нет слова "Карамазовы"
SELECT title, author, price
FROM book
WHERE title NOT LIKE '%Карамазовы%';


--Операторы NOT IN и OT LIKE
--Получаем книги, исключая авторов Булгаков и Достоевский
--и исключая книги, в названии которых есть слово "Игрок"
SELECT title, author, price
FROM book
WHERE author NOT IN ('Булгаков М.А.', 'Достоевский Ф.М.')
